...
st.markdown("Hoş geldiniz. Bu platform, verilerinizi hızlı ve güvenli bir şekilde yükleyerek kapsamlı analizler gerçekleştirmenize ve etkili görselleştirmeler oluşturmanıza olanak tanır.")
...
if uploaded_file:
    ...
    tab1, tab2, tab3, tab4 = st.tabs([" Veri Önizleme", " Filtreleme", " Grafik Oluşturma", " İndirme"])
